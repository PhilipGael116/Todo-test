const Header = () => {
    return (
        <div>
            <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 px-6 xl:px-30 py-4 bg-white sticky top-0 z-50">
                <div className="flex items-center gap-8">
                    <div className="flex items-center gap-3 text-[#2b8cee]">
                        ...
                        <h2 className="text-slate-900 text-xl font-extrabold leading-tight tracking-tight">Todo</h2>
                    </div>

                    <nav className="hidden md:flex items-center gap-6">
                        <a className="text-[#2b8cee] text-sm font-semibold leading-normal" href="#">Dashboard</a>
                        <a className="text-slate-500 text-sm font-medium leading-normal hover:text-[#2b8cee] transition-colors" href="#">Focus</a>
                        <a className="text-slate-500 text-sm font-medium leading-normal hover:text-[#2b8cee] transition-colors" href="#">Vault</a>
                        <a className="text-slate-500 text-sm font-medium leading-normal hover:text-[#2b8cee] transition-colors" href="#">Insights</a>
                    </nav>
                </div>
                ...
                <div className="flex flex-1 justify-end gap-4 items-center">
                    ...
                    <button className="p-2 rounded-lg bg-slate-100 text-slate-600 dark:text-slate-300 hover:bg-slate-200 transition-colors">
